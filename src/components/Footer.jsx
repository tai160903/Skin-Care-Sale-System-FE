...
import { Facebook, Instagram, YouTube, MailOutline, Phone } from "@mui/icons-material";
    ...
    <footer className="bg-gray-200 text-gray-700 py-8 px-12">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p className="mt-2 text-sm">Chăm sóc làn da bạn với sản phẩm thiên nhiên.</p>
        </div>
        ...
        <div>
          ...
          <ul className="mt-2 space-y-2">
            <li><Link to="/privacy-policy" className="hover:text-green-700">Chính sách bảo mật</Link></li>
            <li><Link to="/terms" className="hover:text-green-700">Điều khoản sử dụng</Link></li>
            <li><Link to="/support" className="hover:text-green-700">Hỗ trợ khách hàng</Link></li>
            <li><Link to="/blog" className="hover:text-green-700">Blog</Link></li>
            <li><Link to="/questions" className="hover:text-green-700">Hỏi đáp</Link></li>
          </ul>
        </div>
