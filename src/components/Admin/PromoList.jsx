...
import { getPromotion,updatePointCondition,getPointCondition } from "../../services/adminService/promoService";
...
const PromoList = () => {
  ...
  const handleUpdatePointInfo = async () => {
    ...
    try {
      ...
      await updatePointCondition({id: pointInfo[0].id , condition: updatedValue }); 
      setPointInfo(updatedValue);
      setIsEditing(false); 
